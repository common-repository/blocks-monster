...
class Social_Share {
	...
	public function render( $attributes = [], $content = '', $block = null ) {
		$label = $attributes['label'] ?? esc_html__( 'Share on:', 'blocks-monster' );
		...
		<div <?php echo $wrapper_attributes; ?>>
			<?php if ( $show_label ) : ?>
				<span class='bm-social-share__label'><?php echo esc_html( $label ); ?></span>
			<?php endif; ?>
			<?php if ( $whatsapp ) : ?>
				<a class="bm-social-share__whatsapp" href='https://api.whatsapp.com/send?text=<?php echo esc_attr( $post_content ); ?>%0A<?php echo esc_url( $link ); ?>' target='_blank'>
			...
			<?php endif; ?>
			<?php if ( $facebook ) : ?>
				<a class="bm-social-share__facebook" href='https://www.facebook.com/sharer/sharer.php?u=<?php echo esc_url( $link ); ?>&quote=<?php echo esc_attr( $post_content ); ?>' target='_blank'>
			...
			<?php endif; ?>
			<?php if ( $twitter ) : ?>
				<a class="bm-social-share__twitter" href='https://twitter.com/intent/tweet?text=<?php echo esc_attr( $post_content ); ?>&url=<?php echo esc_url( $link ); ?>' target='_blank'>
					<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
